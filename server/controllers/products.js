    ...
    if (mode === "admin") {
        ...
        if (dividerLocation !== -1) {
            ...
            for (let i = 0; i < queryArray.length; i++) {
                ...
                if (
                    queryArray[i].indexOf("filters") !== -1 &&
                    queryArray[i].indexOf("subCategories") !== -1
                ) {
                ...
                if (queryArray[i].indexOf("filters") !== -1) {
                    ...
                    if (queryArray[i].indexOf("category") === -1 && queryArray[i].indexOf("subCategories") === -1) {
        ...
        if ((filterObj.category && filterObj.category.equals) || (filterObj.subCategory && filterObj.subCategory.equals)) {
            delete whereClause.category; // Remove category filter from whereClause
            delete whereClause.subCategory; // Remove subCategory filter from whereClause
        }
        ...
        if (Object.keys(filterObj).length === 0) {
            ...
            if (filterObj.category && filterObj.category.equals) {
                if (filterObj.subCategory && filterObj.subCategory.equals) {
                    let items = filterObj.subCategory.equals.split(',');
