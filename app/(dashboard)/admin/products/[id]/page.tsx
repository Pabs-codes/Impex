...
const DashboardProductDetails = ({
    ...
    useEffect(() => {
        if (product?.categoryId) {
            setCurrentSubCategories(categories?.find((category) => category.id === product?.categoryId)?.subCategories || []);
        }
    ...
    const deleteProduct = async () => {
        ...
        axiosInstance.delete(`/products/${id}`)
            ...
            .catch((err) => {
                toast.error("There was an error while deleting product" + err);
            });
    };
    ...
    const fetchProductData = async () => {
        ...
        axiosInstance.get(`/products/${id}`)
            ...
            .catch((err) => {
                toast.error("There was an error while fetching product" + err);
            });
        ...
        axiosInstance.get(`/images/${id}`)
            ...
            .catch((err) => {
                toast.error("There was an error while fetching images" + err);
            });
    };
    ...
    const fetchCategories = async () => {
        ...
        axiosInstance.get("/categories")
            ...
            .catch((err) => {
                toast.error("There was an error while fetching categories" + err);
            });
    };
                ...
                <div>
                    <label className="form-control w-full max-w-xs">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                product && setProduct({...product, subCategoryID: e.target.value})
                            }
                        >
